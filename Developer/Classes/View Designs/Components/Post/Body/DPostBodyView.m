...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _images = [[NSArray alloc] initWithObjects:@"1.jpg",@"2.jpg",@"3.jpg",@"4.jpg",@"5.jpg", nil];
...
-(void)interchangeViews
{
    ...
    [_backImageView setImage:[UIImage imageNamed:_postImage.images[_index]]];
...
-(void)transitionNewImage
{
    ...
    if(_isNeedToPlayImages)
    {
        ...
        float duration = [_postImage.durationList[_index] floatValue];
...
-(void)seekContentToPercentage:(NSNumber *)percentage
{
    ...
    if(index)
    {
        if(_currentVisibleImageIndex != index)
        {
            ...
            [_frontImageView setImage:[UIImage imageNamed:_postImage.images[index]]];
            [_backImageView setImage:[UIImage imageNamed:_postImage.images[index-1]]];
...
-(NSInteger)totalImageDuartions
{
    ...
    NSInteger count = [[_postImage durationList]  count];
    for (int i=0; i<count; i++)
    {
        duration = duration + [[_postImage durationList][i] integerValue];
    }
...
{
    NSInteger currentIndex = [[_postImage durationList]  count] - 1;
    NSInteger value = currentTime;
    NSInteger count = [[_postImage durationList]  count];
    for (int i=0; i<count; i++)
    {
        NSInteger duration = [[_postImage durationList][i] integerValue];
...
-(NSInteger)currentImageIndex:(NSInteger )currentTime
{
    ...
    for (int i=0; i<count; i++)
    {
        ...
        NSInteger duration = [[_postImage durationList][currentIndex] integerValue];
